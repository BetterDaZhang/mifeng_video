...
import com.letv.autoapk.widgets.NetImageView18_10;
...
class HeadLineViewPagerAdapter extends PagerAdapter implements OnClickListener {
	...
	public HeadLineViewPagerAdapter(Context context, List<View> pageViews, List<DisplayVideoInfo> scrollList,boolean isShow) {
...
//		headlineBrief.setText(scrollList.get(mPosition).getVideoDesc());
		...
		vpImageView.setDefaultImageResId(R.drawable.default_img_16_10);
		vpImageView.setErrorImageResId(R.drawable.default_img_16_10);
		String url = scrollList.get(mPosition).getImageUrl();
		vpImageView.setCoverUrl(url, context);
//		vpImageView.setImageUrl(scrollList.get(mPosition).getImageUrl(), LruImageCache.getImageLoader(context));
