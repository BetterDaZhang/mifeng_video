...
public class PlayLiveVideoFragment extends BaseFragment {

	private static final String TAG = PlayLiveVideoFragment.class.getSimpleName();
...
//		}
	...
	private ItimeShiftListener timeShiftListener = new ItimeShiftListener() {
		...
		public void onChange(long serverTime1, long positionTime1, long beginTime1) {
			...
			if (beginTime > 0 && positionTime > 0) {
				betweenTime = positionTime - beginTime;
