...
public class WheelView extends View {
	...
	/** 条目的文本颜色 */
	private static int ITEMS_TEXT_COLOR = 0xFFE1E1E1;

	/** 顶部和底部阴影颜色 */
	private static int[] SHADOWS_COLORS = new int[] { 0xFFFFFFF, 0x00AAAAAA, 0x00AAAAAA };

	/** 附加条目的高度(被添加到标准文本条目的高度) */
	...
	private void initData(Context context) {
		...
		VALUE_TEXT_COLOR = getResources().getColor(R.color.code4);
		ITEMS_TEXT_COLOR = getResources().getColor(R.color.code4);
	...
	private void initResourcesIfNecessary() {
		...
		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(R.drawable.date_wheel_val);
		}
